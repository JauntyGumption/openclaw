...
Use runtime-provided startup context first. It may already include `AGENTS.md`, `SOUL.md`, `USER.md`, `HEARTBEAT.md`, recent daily memory (`memory/YYYY-MM-DD.md`), and `MEMORY.md` (main session only).
