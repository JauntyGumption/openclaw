...
describe("progress_card tool", () => {
  it("describes capability without imposing ambient maintenance behavior", () => {
    ...
    expect(tool.description).not.toContain("Keep it current");
    expect(tool.description).not.toContain("any task that takes more than a moment");
    expect(tool.description).not.toContain("how the user watches you work");
  });
